...
if (isset($_GET['delete_id'])) {
    ...
    $deleteSql = "DELETE FROM doner_table WHERE id = $deleteId";
    ...
    $resetAutoIncrementSql = "ALTER TABLE doner_table AUTO_INCREMENT = 1";
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row['last_donate'] . "</td>";
                echo "<td>" . $row['donate_message'] . "</td>";
                echo "<td class='action-column'>";
                echo "<a href='donerr.php?id=" . $row['id'] . "' class='action-button edit'>Edit</a>";
                echo " ";
